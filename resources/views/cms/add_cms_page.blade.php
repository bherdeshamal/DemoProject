                ...
                <div class="page-breadcrumb">
                    <div class="row">
                        <div class="col-12 d-flex no-block align-items-center">
                            <h4 class="page-title">CMS Pages Management</h4>
			    ...
			    @endif
                    ...
                    <div class="card">
                        <div class="card-body wizard-content">
                            ...
                            <form method="POST" action="/cmsaction">
                                {{ csrf_field() }}
                                <div>
                                    <h3>Create Your CMS Page</h3>
                                    </br>
                                    </br>
                                    <section>
                                        ...
                                        <input id="url" name="url" type="text" class="required form-control">
                                    ...
                                    <section>
                                        <div class="form-group">
                                            <div class="col-md-8 col-md-offset-4">
                                                ...
                                                <input type="submit" value="CREATE CMS PAGE" class="btn btn-success">
                                            </div>
                                        </div>
                                    </section>
                                    <section>
