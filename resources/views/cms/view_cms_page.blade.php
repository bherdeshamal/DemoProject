                ...
                <div class="container-fluid">
                    ...
                    <div class="card">
                        <div class="card-body wizard-content">
                            <h6 class="card-subtitle"></h6>
                                ...
                                <div>
                                    ...
                                    <section>
                                        ...
                                        <a href="/add_cms_page" class="btn btn-primary">   Add New CMS Page</a>  
                            ...
                            <thead>
                            <tr>
                            <th><b><font color="red">CMS No</th>
                            <th><b><font color="red">CMS Title</th>
                            <th><b><font color="red">CMS Description</th>
                            <th><b><font color="red">CMS URL</Th>
                            <th><b><font color="red">CMS Status</th>
                            ...
                            <td><a href="click_editcms/{{$cms->id}}" class="btn btn-success" >EDIT</a></td>
                           
                            <td><a href="click_deletecms/{{$cms->id}}" class="btn btn-danger" onclick="return confirm('Are you sure you want to delete?')">DELETE</a></td>
                            </tbody>
                            @endforeach
                            </table>
