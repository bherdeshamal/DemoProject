                ...
                <div class="page-breadcrumb">
                    <div class="row">
                        <div class="col-12 d-flex no-block align-items-center">
                            <h4 class="page-title">CMS PAGE Management</h4>
                ...
                @endif
                    ...
                    <div class="card">
                        <div class="card-body wizard-content">
                            ...
                            <form action="{{ route('updatecms', $cms['id']) }}" method="POST">
                                {{ csrf_field() }}
                                <div>
                                    ...
                                    <section>
                                        ...
                                        <input id="title" name="title" type="text" value='<?php echo $cms['title']; ?>' class="required form-control">
                                        <span class="text-danger">{{ $errors->first('title') }}</span>
                                        </br> 
                                      
                                        </br>
                                        <label for="description">Edit Description *</label>
                                        <input id="description" name="description" type="textarea" value='<?php echo $cms['description']; ?>' class="required form-control">
                                        <span class="text-danger">{{ $errors->first('title') }}</span>
                                        </br> 
                                      
                                        </br>
                                        <label for="url">Edit Category URL *</label>
                                        <input id="url" name="url" type="text" value='<?php echo $cms['url']; ?>' class="required form-control">
                                        <span class="text-danger">{{ $errors->first('title') }}</span>
                                        </br> 
                                    ...
                                    <section>
                                        <div class="form-group">
                                            <div class="col-md-8 col-md-offset-4">
                                                <a href="/view_cms_page" class="btn btn-success">  BACK</a>        
