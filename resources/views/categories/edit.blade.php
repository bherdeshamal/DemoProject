                            ...
                            <form action="{{ route('updatec', $category['id']) }}" method="POST">
                                ...
                                <div>
                                    ...
                                    <section>
                                        ...
                                        <input id="name" name="name" type="text" value='<?php echo $category['name']; ?>' class="required form-control">
                                        <span class="text-danger">{{ $errors->first('name') }}</span>
                                        </br>  </br> 
                                      
                                        </br>
                                        <label for="desc">Edit Category Description *</label>
                                        <input id="desc" name="desc" type="text" value='<?php echo $category['desc']; ?>' class="required form-control">
                                        <span class="text-danger">{{ $errors->first('desc') }}</span>
                                        </br>  </br> 
                                      
                                        </br>
                                        <label for="url">Edit Category URL *</label>
                                        <input id="url" name="url" type="text" value='<?php echo $category['url']; ?>' class="required form-control">
                                    ...
                                    <section>
                                        <div class="form-group">
                                            <div class="col-md-8 col-md-offset-4">
                                                <a href="/categoryview" class="btn btn-success">  BACK</a>        
