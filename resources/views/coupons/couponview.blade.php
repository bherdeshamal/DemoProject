                ...
                <div class="container-fluid">
                    ...
                    <div class="card">
                        <div class="card-body wizard-content">
                            ...
                            <form method="POST" action="/couponaction">
                                ...
                                <div>
                                    ...
                                    <section>
                                        ...
                                        <a href="/coupon" class="btn btn-primary">   Add New Coupon</a>  
                                        
                                        <a href="/export-coupons" class="btn btn-info">   Exports</a> 
                            ...
                            <thead>
                            <tr>
                            <th><b><font color="red">Coupon No</th>
                            <th><b><font color="red">Coupon Code</th>
                            <th><b><font color="red">Coupon Amount</th>
                            <th><b><font color="red">Coupon Amount Type</th>
                            <th><b><font color="red">Coupon Expiry Date</th>
                            <th><b><font color="red">Coupon Status</th>
                            ...
                            <td>
                                @if($coupon->status==1)Active @else Expires @endif    
                            </td>
                            <td> <a href="click_editcoupon/{{$coupon->id}}" class="btn btn-success">EDIT</a></td>
                            <td><a href="click_deletecoupon/{{$coupon->id}}" class="btn btn-danger" onclick="return confirm('Are you sure you want to delete?')">DELETE</a></td>
                            </tbody>
                            @endforeach
                            </table>
