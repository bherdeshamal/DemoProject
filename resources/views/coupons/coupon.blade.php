                ...
                @endif
                    ...
                    <div class="card">
                        <div class="card-body wizard-content">
                            ...
                            <form method="POST" action="/couponaction" >
                                {{ csrf_field() }}
                                <div>
                                    <h3>Create Coupon</h3>
                                    </br>
                                    ...
                                    <input id="coupon_code" name="coupon_code" type="text"  class="required form-control">
                                    </br>  <span class="text-danger">{{ $errors->first('coupon_code') }}</span>
                                    </br>
                                    <label for="amount">Enter Amount </label>
                                    <input id="amount" name="amount" type="number"  class="required form-control">
                                    </br>  <span class="text-danger">{{ $errors->first('amount') }}</span>
                                    </br>
                                    <label for="amount_type">Enter Amount Type </label>
                                    </br>  <span class="text-danger">{{ $errors->first('amount_type') }}</span>
                                    <select id="amount_type" name="amount_type" class="required form-control">
                                        <option value="Percentage">Percentage</option>
                                        <option value="Amount">Amount</option>
                                    </select>
                                    </br>
                                    <label for="expiry_date">Expiry Date </label>
                                    <input type="date" name="expiry_date" id="expiry_date" class="required form-control">
                                    ...
                                    <section>
                                        <div class="form-group">
                                            <div class="col-md-8 col-md-offset-4">
                                                ...
                                                <input type="submit" value="Create Coupon" class="btn btn-success">
                                            </div>
                                        </div>
                                    </section>
                                    <section>
