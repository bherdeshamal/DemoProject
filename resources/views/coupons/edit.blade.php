                ...
                <div class="container-fluid">
                    ...
                    <div class="card">
                        <div class="card-body wizard-content">
                            ...
                            <form method="post" action="{{ route('updatecoupon', $coupon['id']) }}" >
                                {{ csrf_field() }}
                                <div>
                                    <h3>Edit Coupon</h3>
                                    </br>
                                    ...
                                    <section>
                                        <label for="coupon_code">Edit Coupon Code </label>
                                        <input id="coupon_code" name="coupon_code" type="text" value="{{$coupon->coupon_code}}" class="required form-control">
                                        </br>  <span class="text-danger">{{ $errors->first('coupon_code') }}</span>
                                        </br>
                                        <label for="amount">Edit Amount </label>
                                        <input id="amount" name="amount" type="number" value="{{$coupon->amount}}" class="required form-control">
                                        </br>  <span class="text-danger">{{ $errors->first('amount') }}</span>
                                        </br>
                                        <label for="amount_type">Edit Amount Type </label>
                                        </br>  <span class="text-danger">{{ $errors->first('amount_type') }}</span>
                                        <select id="amount_type" name="amount_type"  value="{{$coupon->amount_type}}" class="required form-control">
                                            <option value="Percentage">Percentage</option>
                                            <option value="Amount">Amount</option>
                                        </select>
                                        </br>
                                        <label for="expiry_date">Expiry Date </label>
                                        <input type="date" name="expiry_date" id="expiry_date" value="{{$coupon->expiry_date}}" class="required form-control">
                                        </br>  <span class="text-danger">{{ $errors->first('expiry_date') }}</span>
                                        </br>
                                        <label for="status">Enable </label>
                                    <select name="status" id="status" value="{{$coupon->status}}" class="required form-control">
                                    <option value=1>Active</option>
                                    <option value=2>In-Active</option>
                                    </select> </br>  <span class="text-danger">{{ $errors->first('status') }}</span>
                                        </br>
                                    </section>
                                    </br>
                                    <section></br>
                                    ...
                                    <section>
                                        <div class="form-group">
                                            <div class="col-md-8 col-md-offset-4">
                                                <a href="/couponview" class="btn btn-success">  BACK</a>        
