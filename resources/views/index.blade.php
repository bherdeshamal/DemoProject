										...
										<div class="product-image-wrapper">
											<div class="single-products">
												<div class="productinfo text-center">
													...
													<h2>{{$product->price}}</h2>
													<p>{{$product->name}}</p>
													<a href="/shoplogin" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Add to cart</a>
													...
													<div class="product-overlay">
														...
														<h2>{{$product->price}}</h2>
														<p>{{$product->name}}</p>
														<a href="/shoplogin" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Add to cart</a></br>
														</div>
													</div>
								   			</div>
								  		    <div class="choose">
											<ul class="nav nav-pills nav-justified">
											<li><a href="/shoplogin" onclick="return confirm('E-SHOPPER SAYS Please Login First')"><i class="fa fa-plus-square" ></i>Add to wishlist</a></li>
											<li><a href="/shoplogin"<i class="fa fa-plus-square"></i>Add to cart</a></li>
											</ul>
								            </div>
							            </div>
									</div>
