                            ...
                            <form method="post" action="{{ route('updateproduct', $product['id']) }}" enctype="multipart/form-data">
                                ...
                                <div>
                                    ...
                                    <section>
                                        ...
                                        <input id="name" name="name" type="text" value='<?php echo $product['name']; ?>' class="required form-control">
                                        <span class="text-danger">{{ $errors->first('name') }}</span>
                                        </br>  </br>
                                       
                                       
                                        <label for="desc">Edit Product Price </label>
                                        <input id="price" name="price" type="number" value='<?php echo $product['price']; ?>' class="required form-control">
                                        <span class="text-danger">{{ $errors->first('price') }}</span>
                                        </br>  </br>
                                        <label for="url">Edit Product Image </label>
                                        <input id="image" name="image" type="file" value='<?php echo $product['image']; ?>' class="required form-control">
                                        <span class="text-danger">{{ $errors->first('image') }}</span>
                                        </br>  </br>
                                       <label for="productcategory">Select Category </label>
                                        <select name="productcategory" id="productcategory" class="required form-control">
                                        @foreach($key as $row)
                                        <option value="{{ $row['id'] }}" {{ ($row['id'] == $product['productcategory'] ) ? 'selected' : ''  }}>{{$row['name']}}</option> 
                                        @endforeach
                                        </select>
                                    ...
                                    <section>
                                        <div class="form-group">
                                            <div class="col-md-8 col-md-offset-4">
                                                <a href="/productview" class="btn btn-success">  BACK</a>        
