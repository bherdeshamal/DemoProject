                ...
                <div class="container-fluid">
                    ...
                    <div class="card">
                        <div class="card-body wizard-content">
                            ...
                            <thead>
                            <tr>
                            <th><b><font color="red">Product No</th>
                            <th><b><font color="red">Product Name</th>
                            <th><b><font color="red">Product Price</th>
                            <th><b><font color="red">Product Image</th>
                            <th><b><font color="red">Product Category</th>
                            ...
                            <td>{{$product->name}} </td>
                            <td>{{$product->price}} </td>
                            <td><img src="{{asset('pimg/'.$product->image)}} " width="200px" height="200px"></td>
                            <td>{{$product->productcategory}}</td>
                            
                            <td class="center"> <a href="click_editproduct/{{$product->id}}" class="btn btn-success">EDIT</a></td>
                            <td class="center"><a href="click_deleteproduct/{{$product->id}}" class="btn btn-danger" onclick="return confirm('Are you sure you want to delete?')">DELETE</a></td>
                              </tr>
