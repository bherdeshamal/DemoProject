    ...
    <div id="main-wrapper" data-layout="vertical" data-navbarbg="skin5" data-sidebartype="full"
        ...
        <div class="page-wrapper">
                    ...
                    <div class="col-md-6 col-lg-4 col-xlg-3">
                        <div class="card card-hover">
                            <div class="box bg-success text-center">
                                ...
                                <h6 class="text-white">Banners</h6>
                            </div>
                        </div>
                    </div>
                    <!-- Column -->
                    ...
                    <div class="col-md-6 col-lg-2 col-xlg-3">
                        <div class="card card-hover">
                            <div class="box bg-danger text-center">
                                ...
                                <h6 class="text-white">Coupons</h6>
                            </div>
                        </div>
                    </div>
                    <!-- Column -->
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-6">
                                                <div class="bg-dark p-10 text-white text-center">
                                                    ...
                                                    <h5 class="mb-0 mt-1">{{$cur_month}}</h5>
                                                    <small class="font-light">For Month</small>
                                                </div>
                                            </div>
                                            <div class="col-6 mt-3">
                                                <div class="bg-dark p-10 text-white text-center">
                                                    <i class="fa fa-cart-plus mb-1 font-16"></i>
                                                    <h5 class="mb-0 mt-1">{{$categories}}</h5>
                                            ...
                                            <div class="col-6 mt-3">
                                                <div class="bg-dark p-10 text-white text-center">
                                                    ...
                                                    <h5 class="mb-0 mt-1">{{$coupons}}</h5>
                                                    <small class="font-light">Total Coupons</small>
                                                </div>
                                            </div>
                                            <div class="col-6 mt-3">
                                                <div class="bg-dark p-10 text-white text-center">
            ...
            <footer class="footer text-center">
                Designed and Developed by Shamal Bherde
            </footer>
            <!-- ============================================================== -->
            <!-- End footer -->
            <!-- ============================================================== -->
