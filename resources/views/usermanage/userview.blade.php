                ...
                <div class="container-fluid">
                    ...
                    <div class="card">
                        <div class="card-body wizard-content">
                            <h6 class="card-subtitle"></h6>
                                ...
                                <div>
                                    ...
                                    <section>
                                        ...
                                        <a href="/usermanage" class="btn btn-primary">   Add New User</a>  
                            ...
                            <th><b><font color="red">User FirstName</th>
                            <th><b><font color="red">User LastName</th>
                            <th><b><font color="red">User Email</th>
                            <th><b><font color="red">User Password</th>
                            <th><b><font color="red">User Confirm Password</th>
                            <th><b><font color="red">User Status</th>
                            <th><b><font color="red">User Rolename</th>
                            <th colspan =2><b><font color="red"> Action</th>
                            </tr>
                            </thead>
                            <tbody>
                            @foreach($userms as $row)
                            ...
                            <td>{{$row->status}}</td>
                            <td>{{$row->rolename}}</td>
                            <td> <a href="click_edituser/{{$row->id}}" class="btn btn-success">EDIT</a></td>
                            <td><a href="click_deleteuser/{{$row->id}}" class="btn btn-danger" onclick="return confirm('Are you sure you want to delete?')">DELETE</a></td>
                            </tbody>
                            @endforeach
                            </table>
                            {!! $userms->links('pagination::bootstrap-4')!!}
                            </section>
                            </div>
                            </form>
                        </div>
