                        ...
                        <form action="{{ route('updateuser', $user['id']) }}" method="POST">
                         {{ csrf_field() }}
                                ...
                                <section>
                                    ...
                                    <input id="name" name="name" type="text" value="{{$user->name}}" class="required form-control">
                                    <span class="text-danger">{{ $errors->first('name') }}</span>
    
                                     </br>
                                         </br>
                                    <label for="name">Last Name </label>
                                    <input id="lname" name="lname" type="text" value="{{$user->lname}}" class="required form-control">
                                    ...
                                    <input id="email" name="email" type="email" value="{{$user->email}}" class="required form-control">
                                    <span class="text-danger">{{ $errors->first('email') }}</span>
    
                                        </br>
                                        </br>
                                                <label for="pass">Password</label>
                                    <input id="pass" name="pass" type="password" value="{{$user->pass}}" class="required form-control">
                                    <span class="text-danger">{{ $errors->first('pass') }}</span>
    
                                    </br>
                                    </br>
                                   <label for="cpass">Confirm Password </label>
                                    <input id="cpass" name="cpass" type="password" value="{{$user->cpass}}" class="required form-control">
                                    <span class="text-danger">{{ $errors->first('cpass') }}</span>
                                        ...
                                        <label for="status">Select Status </label>
                                                ...
                                                <input type="radio" id="active" name="status" value="{{$user->status}}" >
                                                <label for="male">Active</label>
                                                <input type="radio" id="inactive" name="status" value="{{$user->status}}" >
                                    ...
                                    <select name="rolename" id="rolename" class="required form-control">
