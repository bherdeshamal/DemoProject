				...
				<div class="row">
					<div class="col-md-4 clearfix">
						<div class="logo pull-left">
							<a href="index.html"><img src="{{asset('images/frontimages/home/logo.png')}}" alt="" /></a>
						</div>
						...
						<div class="mainmenu pull-left">
							<ul class="nav navbar-nav collapse navbar-collapse">
								...
								<li><a href="/account"> Account</a></li>
										...
										<li><a href="/frontlogin">Login</a></li> 
                                    </ul>
                                </li> 
								<li class="dropdown"><a href="/404">Blog<i class="fa fa-angle-down"></i></a>
                                    <ul role="menu" class="sub-menu">
                                        <li><a href="/blog1">Blog List</a></li>
										<li><a href="/blogsingl1">Blog Single</a></li>
                                    </ul>
                                </li> 
			...
			<div class="row">
				...
				<div class="col-sm-9 padding-right">
					<div class="product-details"><!--product-details-->
								  ...
								  <!-- Wrapper for slides -->
								    <div class="carousel-inner">
										<div class="item active thumbnail">
											...
											<a href="{{asset('pimg/'.$pkey->image)}}" data-standard="{{asset('pimg/'.$pkey->image)}}">
											</br> </br><img src="{{asset('pimg/'.$pkey->image)}} " width="300px" height="300px">
											</br>
											</a><hr>
											</hr>
						...
						<div class="col-sm-7">
							<form method="post" action="{{ url('add-cart')}}" id="cartbutton" name="cartbutton" >
								{{csrf_field()}}
                            
                                <input type="hidden" name="product_id" value="{{$pkey->id}}" >
							       
						        	<input type="hidden" name="name" value="{{$pkey->name}}" >
							        <input type="hidden" name="price" value="{{$pkey->price}}" >
							
								<div class="product-information"><!--/product-information-->
								
									</hr><hr>
									<p>Product ID: {{$pkey->id}}</p>
									</br> </br><img src="{{asset('pimg/'.$pkey->image)}}  " width="100px" height="100px">
									...
									<p><b>Price :</b> {{$pkey->price}} Rs</p>
									<p><b>Product Name :</b> {{$pkey->name}}</p>
					...
					<div class="category-tab shop-details-tab"><!--category-tab-->
						<div class="col-sm-12">
							<ul class="nav nav-tabs">
								<li class="active"><a href="#reviews" data-toggle="tab">Send Feedback</a></li>
							</ul>
						</div>
							...
							<div class="tab-pane fade" id="details" >
								<div class="col-sm-3">
									<div class="product-image-wrapper">
										<div class="single-products">
											...
											<img src="{{asset('images/frontimages/product-details/5.jfif')}}" alt="" />
											</br>
											<h2>$56</h2>
								...
								<div class="col-sm-3">
									<div class="product-image-wrapper">
										<div class="single-products">
											<div class="productinfo text-center">
											<img src="{{asset('images/frontimages/product-details/4.jfif')}}" alt="" />
													<h2>$56</h2>
												<p>Easy Polo Black Edition</p>
												<button type="button" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Add to cart</button>
											</div>
							...
							<div class="tab-pane fade" id="companyprofile" >
								<div class="col-sm-3">
									<div class="product-image-wrapper">
										<div class="single-products">
											<div class="productinfo text-center">
											<img src="{{asset('images/frontimages/product-details/7.jfif')}}" alt="" />
												<h2>$56</h2>
												<p>Easy Polo Black Edition</p>
												<button type="button" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Add to cart</button>
											</div>
								...
								<div class="col-sm-3">
									<div class="product-image-wrapper">
										<div class="single-products">
											<div class="productinfo text-center">
											<img src="{{asset('images/frontimages/product-details/3.jfif')}}" alt="" />
													<h2>$56</h2>
												<p>Easy Polo Black Edition</p>
												<button type="button" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Add to cart</button>
											</div>
							...
							<div class="tab-pane fade" id="tag" >
								...
								<div class="col-sm-3">
									<div class="product-image-wrapper">
										<div class="single-products">
											<div class="productinfo text-center">
											<img src="{{asset('images/frontimages/product-details/2.jfif')}}" alt="" />
												<h2>$56</h2>
												<p>Easy Polo Black Edition</p>
												<button type="button" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Add to cart</button>
											</div>
							...
							<div class="tab-pane fade active in" id="reviews" >
								<div class="col-sm-12">
									...
									{{ csrf_field() }}  
										...
										<b>Rating: </b> <img src="{{asset('images/frontimages/product-details/rating.png')}}" alt="" />
