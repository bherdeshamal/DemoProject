					...
					<div class="col-sm-6">
						<div class="contactinfo">
							<ul class="nav nav-pills">
								<li><a href="#"><i class="glyphicon glyphicon-earphone"></i> +2 95 01 88 821</a></li>
								<li><a href="#"><i class="glyphicon glyphicon-globe"></i> info@domain.com</a></li>
							</ul>
						</div>
					</div>
					<div class="col-sm-6">
					...
					<div class="col-sm-9">
						...
						<div class="mainmenu pull-left">
							<ul class="nav navbar-nav collapse navbar-collapse">
								<li><a href="dashboard" class="active"><i class="glyphicon glyphicon-home"></i> Home</a></li>
					...
					<div class="col-sm-2">
						<div class="single-widget">
							...
							<ul class="nav nav-pills nav-stacked">
								<li><a href="{{url('pages/$cmsPageDetails->url')}}">Online Help</a></li>
								<li><a href="{{url('pages/$cmsPageDetails->url')}}">Contact Us</a></li>
