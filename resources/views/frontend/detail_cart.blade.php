					...
					<div class="col-md-8 clearfix">
						<div class="shop-menu clearfix pull-right">
							<ul class="nav navbar-nav">
								...
								<li><a href="orders"><i class="fa fa-star"></i> My Orders</a></li>
						...
						<tr>
							...
							<td class="cart_quantity">
								<div class="cart_quantity_button">
									<a class="cart_quantity_up" href="/cart/update-product/{{$cart->id}}/+1"> + </a>
                            ...
                            <td class="cart_delete">
								<a class="cart_quantity_delete" href="{{url('/cart/delete-product/' .$cart->id)}}"><i class="fa fa-times">X</i></a>
							</td>
			...
			<div class="row">
					...
					<div class="chose_area">
						<ul class="user_option">
							<li>
								...
								<input type="submit" value= "Apply Coupon" class="btn btn-default check_out">
								</form>
							</li>
				...
				<div class="col-sm-6">
					<div class="total_area">
						...
						<a class="btn btn-default check_out" href="indexcheckout">Check Out</a>
					</div>
				</div>
			</div>
		</div>
