                        ...
                        <div class="card-body wizard-content">
                            ...
                            <form action="{{ route('sendreplyback', $category['id']) }}" method="POST">
                                ...
                                <div>
                                    ...
                                    <input name="name" type="text"  value='<?php echo $category['name']; ?>' class="required form-control">
                                    <span class="text-danger">{{ $errors->first('name') }}</span>
                                    </br>
                                    </br> 
                                    <label for="email">Contact Email-Id </label>
                                    <input  name="email" type="email" value='<?php echo $category['email']; ?>' class="required form-control">
                                    <span class="text-danger">{{ $errors->first('email') }}</span>
                                    </br>
                                    </br> 
                                    <label for="reply">Send Reply </label>
                                    <input  name="reply" type="text"  class="required form-control">
