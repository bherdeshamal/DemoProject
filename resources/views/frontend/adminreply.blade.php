                        ...
                        <ul class="navbar-nav float-end">
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <ul class="dropdown-menu dropdown-menu-end user-dd animated" aria-labelledby="navbarDropdown">
                                    ...
                                    <a class="dropdown-item" href="vieworders"><i
                                        class="ti-settings me-1 ms-1"></i> View Orders</a>
                                    <div class="dropdown-divider"></div>
            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav" class="pt-4">
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link"
                                href="reports" aria-expanded="false"><i class="mdi mdi-chart-bar"></i><span
                ...
                <div class="container-fluid">
                    ...
                    <div class="card">
                        <div class="card-body wizard-content">
                            ...
                            <form action="{{ route('adminreply', $category['id']) }}" method="POST">
                                {{ csrf_field() }}
                                <div>
                                    <h3>Revert Back</h3>
                                    </br>
                                    ...
                                    <label for="user_email">Contact Email-Id </label>
                                    <input  name="user_email" type="email" value='<?php echo $category['user_email']; ?>' class="required form-control">
                                    <span class="text-danger">{{ $errors->first('user_email') }}</span>
                                    </br>
                                    </br> 
                                    <label for="admin_reply">Send Reply </label>
                                    <input  name="admin_reply" type="text" value="Thankyou For Subscribing E-shopper Website"  class="required form-control">
