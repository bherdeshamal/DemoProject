                        ...
                        <div class="card-body wizard-content">
                            ...
                            <form action="sendupdate" method="POST">
                                ...
                                <div>
                                    ...
                                    <label ><b>To </b></label>
                                    <select name="user_email" disabled style="height:150px;" type="email"   class="required form-control" multiple>
                                            @foreach($user as $row)
                                    ...
                                    <input Disabled type="text" value="New Updates From E-Comm Website" class="required form-control"> </br>
                                     
                                    <label for="admin_reply"><b>Body</b> </label>
                                    </br>
                                    <textarea  name="admin_reply"  style="height:150px; " class="required form-control" required></textarea>
                                    ...
                                    <section>
                                        <div class="form-group">
                                            ...
                                            <a href="/view-subscriptions" class="btn btn-primary">  Back</a>  
