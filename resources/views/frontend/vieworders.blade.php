                    ...
                    <div class="card">
                        <div class="card-body wizard-content">
                            <h6 class="card-subtitle"></h6>
                                ...
                                <div>
                                    ...
                                    <section>
                                        ...
                                        <a href="/export-orders" class="btn btn-info">   Export</a>  
                                        </br>
                            <form>
                            </br>
                            </br>
                          ...
                          @endif
                            ...
                            <th><b><font color="red">State</th>
                             <th><b><font color="red">Coupon Amount</th>
                            <th><b><font color="red">Payment Method</th>
                            <th><b><font color="red">Grand Total</th>
                           ...
                           <td><a href="{{url('order-proceed/'.$order->id)}}" class="btn btn-success">Proceed</button> </td>
                             </tbody>
                            @endforeach
                            </table>
