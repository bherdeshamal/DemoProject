                ...
                <div class="container-fluid">
                    ...
                    <div class="card">
                        <div class="card-body wizard-content">
                            ...
                            <form method="POST" action="/bannersaction" enctype="multipart/form-data">
                                {{ csrf_field() }}
                                <div>
                                    <h3>Create Banner</h3>
                                    </br>
                                    ...
                                    <input id="image" name="image" type="file" class="required form-control">
                                    <span class="text-danger">{{ $errors->first('image') }}</span>
                                    </br>
                                    </br>
                                    <label for="title">Banner Tittle</label>
                                    <input id="title" name="title" type="text" class="required form-control">
                                    <span class="text-danger">{{ $errors->first('title') }}</span>
                                    </br>
                                    </br>
                                    <label for="url">Banner Status</label>
                                      <select id="url" name="url"  class="required form-control">
                                    ...
                                    <section>
                                        <div class="form-group">
                                            <div class="col-md-8 col-md-offset-4">
                                                <a href="/bannerview" class="btn btn-success">  BACK</a>        
                                                <input type="submit" value="Create Bannner" class="btn btn-success">
                                            </div>
                                        </div>
