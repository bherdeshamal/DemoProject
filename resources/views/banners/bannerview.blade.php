                ...
                <div class="container-fluid">
                    ...
                    <div class="card">
                        <div class="card-body wizard-content">
                            <h6 class="card-subtitle"></h6>
                                ...
                                <div>
                                    ...
                                    <section>
                                        ...
                                        <a href="/banner" class="btn btn-primary">   Add New Banner</a>  
                            ...
                            <thead>
                            <tr>
                            <th><b><font color="red">Banner No</th>
                            <th><b><font color="red">Banner Image</th>
                            <th><b><font color="red">Banner Tittle</th>
                            <th><b><font color="red">Banner Status</th>
                            ...
                            <td>{{$banner->id}} </td>
                            <td><img src="{{asset('bannerimg/'.$banner->image)}} " width="200px" height="200px"></td>
                            <td>{{$banner->title}} </td>
                            <td> @if($banner->url==1)Active @else Inactive @endif </td>
                            <td><a href="click_editbanner/{{$banner->id}}" class="btn btn-success" >EDIT</a></td>
                           
                            <td><a href="click_deletebanner/{{$banner->id}}" class="btn btn-danger" onclick="return confirm('Are you sure you want to delete?')">DELETE</a></td>
                            </tbody>
                            @endforeach
                            </table>
