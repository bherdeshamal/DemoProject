                ...
                @endif
                    ...
                    <div class="card">
                        <div class="card-body wizard-content">
                            ...
                            <form action="{{ route('updateconfiguration', $configure['id']) }}" method="POST">
                                {{ csrf_field() }}
                                <div>
                                    ...
                                    <section>
                                        ...
                                        <input id="email" name="email" type="email" value="{{$configure->email}}" class="required form-control">
                                        <span class="text-danger">{{ $errors->first('email') }}</span>
                                        </br> </br>
                                       
                                        <label for="notification_email">Edit Notification Email</label>
                                        <input id="notification_email" name="notification_email" type="email" value="{{$configure->notification_email}}" class="required form-control">
                                    ...
                                    <section>
                                        <div class="form-group">
                                            <div class="col-md-8 col-md-offset-4">
                                                <a href="/configureview" class="btn btn-success">  BACK</a>        
                                                <input type="submit" value="UPDATE CONFIGURATION" class ="btn btn-success">
                                            </div>
                                        </div>
                                        </br> </br> </br>
                                    </section>
