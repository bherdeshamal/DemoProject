                ...
                <div class="container-fluid">
                    ...
                    <div class="card">
                        <div class="card-body wizard-content">
                            ...
                            <form method="POST" action="/configureaction">
                                {{ csrf_field() }}
                                <div>
                                    ...
                                    <section>
                                        ...
                                        <a href="/configure" class="btn btn-primary">   Add New Configuration</a>  
                            ...
                            <thead>
                            <tr>
                            <th><b><font color="red">Configuration No</th>
                            <th><b><font color="red"> Email</th>
                            <th><b><font color="red">Notification Email</th>
                            ...
                            <td>{{$configure->notification_email}} </td>
                            <td> <a href="/click_editconfiguration/{{$configure->id}}" class="btn btn-success">EDIT</a></td>
                            <td><a href="/click_deleteconfiguration/{{$configure->id}}" class="btn btn-danger" onclick="return confirm('Are you sure you want to delete?')">DELETE</a></td>
                            </tbody>
                            @endforeach
                            </table>
