                            ...
                            <form method="post" action="/configureaction">
                                ...
                                <div>
                                    ...
                                    <section>
                                        ...
                                        <label for="noti">Notification Mail</label>
                                        <input id="notification_email" name="notification_email" type="email" class="required form-control">
                                    ...
                                    <section>
                                        <div class="form-group">
                                            <div class="col-md-8 col-md-offset-4">
                                                <input type="submit" value="Configure Email" class="btn btn-success">
                                            </div>
                                        </div>
                                    </section>
                                    <section>
